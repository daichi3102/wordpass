![MeigenOtter](./app/public/MOtop.PNG)
## ■サービス名
...
|名言の本文か名前に対して、フリーワードから検索ができます。|作成された名言に対して、いいねができます。いいねした名言は、マイページから一覧になっています。|
...
|自分の作成した名言に対してのいいね、もしくは自分の未完成な名言（上の句や下の句のみ）に対して新しい句が追加された場合、ヘッダーのインジゲーターにバッジが付き、リンク先に飛ぶと通知一覧が見れます。|気に入った名言があれば、Xにシェアすることができます。生成AIからの名言も、人間が作った名言も、Xシェアすることができます。|
...
|トップページ|ユーザー登録機能|
|:-------------|:-------------|
|[![トップページ](https://i.gyazo.com/b58e1959c2dbb6fcdd01ee2a4545a797.gif)](https://gyazo.com/b58e1959c2dbb6fcdd01ee2a4545a797)|[![ユーザー登録機能](https://i.gyazo.com/5fca3aa7ffa0b06e1788098b243dc3ad.gif)](https://gyazo.com/5fca3aa7ffa0b06e1788098b243dc3ad)|
|アプリのコンセプトが伝わるように、らっこが海から名言を持ってくるという世界観を演出しました。|ボタンの色や配置など、直感的にわかりやすいデザインにしました。|
